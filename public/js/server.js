...
async function updateServerCount() {
  try {
    const response = await axios.get('https://cors-anywg.up.railway.app/https://avlon.up.railway.app/servers');
...
async function updateUserCount() {
  try {
    const response = await axios.get('https://cors-anywg.up.railway.app/https://avlon.up.railway.app/users');
...
async function updateChannelCount() {
  try {
    const response = await axios.get('https://cors-anywg.up.railway.app/https://avlon.up.railway.app/channels');
...
async function updateUptime() {
  try {
    const response = await axios.get('https://cors-anywg.up.railway.app/https://avlon.up.railway.app/uptime');
...
async function updateStatus() {
  try {
    const response = await $.get("https://cors-anywg.up.railway.app/https://avlon.up.railway.app/status");
...
async function checkLoginStatus() {
  try {
    const response = await fetch('https://cors-anywg.up.railway.app/https://avlon.up.railway.app/getProfile');
    if (response.ok) {
